...
Pose waypoints[TOTAL_WAYPOINTS] = {//9段10个点
    ...
    // 点2
    {0.0f, 0.0f, 0.155f, 0.0f, 0.0f, 0.0f},
    // 点3
    {0.25f, 0.2f, 0.155f, 0.0f, 0.0f, 0.0f},
    // 点4
    {-0.25f, 0.25f, 0.155f, 0.0f, 0.0f, 0.0f},
    // 点5
    {-0.25f, -0.25f, 0.155f, 0.0f, 0.0f, 0.0f},
		// 点6
		{0.25f, -0.25f, 0.155f, 0.0f, 0.0f, 0.0f},
		// 点7		
		{0.0f, 0.0f, 0.155f, 0.0f, 0.0f, 0.0f},
//		{0.25f, -0.25f, 0.655f, 0.0f, 0.0f, 0.0f},
//		// 点8		
//		{0.25f, 0.25f, 0.655f, 0.0f, 0.0f, 0.0f},
//		// 点9		
//		{-0.25f, 0.25f, 0.655f, 0.0f, 0.0f, 0.0f},
...
//		{-0.25f, -0.25f, 0.655f, 0.0f, 0.0f, 0.0f},
//		// 点11		
//		{0.0f, 0.0f, 0.355f, 0.0f, 0.0f, 0.0f},
};

Pose waypoints_line[TOTAL_WAYPOINTS_LINE] = {
	// 点1（起点）
    {0.0f, 0.0f, 0.135f, 0.0f, 0.0f, 0.0f},
    // 点2
    {0.0f, 0.0f, 0.155f, 0.0f, 0.0f, 0.0f},
    ...
    {-0.25f, -0.25f, 0.155f, 0.0f, 0.0f, 0.0f},
    // 点4
    {0.25f, 0.25f, 0.635f, 0.0f, 0.0f, 0.0f}
};

uint8_t current_segment = 0;  // 初始执行第0段（A→B）
uint8_t current_segment_line = 0;
...
const Point4f base_g[CABLE_NUM] = {
    {-0.3973844f,  0.2946661f, 0.8249708f, 1.0f}, // b1
    {-0.39016947f, -0.3117137f, 0.8203764f, 1.0f}, // b2
    {0.4035809f, -0.3087257f, 0.8217266f, 1.0f},  // b3
    {0.3980906f,  0.2996931f, 0.8258554f, 1.0f},  // b4
    {-0.3929785f,  0.3195228f, 0.1654011f, 1.0f}, // b5
    {-0.3884854f, -0.3246105f, 0.169f, 1.0f}, // b6
    {0.4064015f, -0.3213016f,  0.169f, 1.0f},  // b7
    {0.4022546f,  0.3224215,  0.169f, 1.0f}   // b8
};
